...
public class MultiExplosionRecipeCategory implements IRecipeCategory<ExplosionMultiItemRecipes> {
    ...
    @Override
    public RecipeType<ExplosionMultiItemRecipes> getRecipeType() {
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, ExplosionMultiItemRecipes recipes, IFocusGroup iFocusGroup) {
    ...
    @Override
    public void getTooltip(ITooltipBuilder tooltip, ExplosionMultiItemRecipes recipe, IRecipeSlotsView recipeSlotsView, double mouseX, double mouseY) {
